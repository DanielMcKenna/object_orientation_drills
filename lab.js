...
console.log(ingredients(fakeObj));
...
let cat1 = new Cat("loki", 23, "brown");
...
let harryPlopper = new Wizard("Harry plops", 23, "leviosa");
...
let galaxys9 = new Phone("samsung", "galaxy", 128, "blue", 700, false);
let iPhone = new Phone("apple", "iphone", 60, "rose gold", 1000, false);
let google = new Phone("google", "google", 150, "black", 850, false);
...
class Vehicle {
  ...
  move(miles) {
    let newMileage = this.mileage;
    newMileage = this.mileage + miles;
...
let myFirstMotorcycle = new Motorcycle(1, "blue", 25, "suzuki", true);
...
let myFirstBoat = new Boat(8, "red", 2, "just add water", "surfboat", false);
